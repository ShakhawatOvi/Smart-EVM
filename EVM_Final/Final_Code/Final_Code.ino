...
char pass[] = "home1234"; // your network password

int votingdone[50];
int sizev = 0;
int buttonState = 0;
int voteflag = 0;  //voteflag = 1 implies vote was not successful
uint8_t id, count;


/*Google Sheets Definations*/
char column_name_in_sheets[ ][6] = {"pb1", "pb2", "pb3"};
String Sheets_GAS_ID = "AKfycbwgsODCxfj0bYvSgEB3kumGH3P1KVFZf16_Kflzji2zMBGH0gGAeP5zS1FzvHVrZBb4";
    ...
    if ((data1 == 1) && (data2 == 0) && (data3 == 0)) {
      ...
      while (!buttonState)
      {
        ...
        if (((millis() - entrypoint) > canceldelay)) {
          voteflag = 1;
          lcd.clear();
          lcd.setCursor (0, 0); lcd.print("Vote not Confirm");
